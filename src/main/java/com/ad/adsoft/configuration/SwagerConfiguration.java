package com.ad.adsoft.configuration;
...
public class SwagerConfiguration {
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder().title("<h1>java spring-boot microservices angular oracle application development</h1>").description(description).termsOfServiceUrl("github")
